        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900">Log de Transacciones</h2>
                        <p className="text-sm text-gray-500">{pagination.total} transacciones totales</p>
                    </div>
                </div>
                <button
                    onClick={exportCSV}
                                ...
                                {filteredTransactions.map(tx => (
                                    <tr key={tx.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-3">
                                            <a href={`/admin/users/${tx.user?.id}`} className="text-blue-600 hover:underline">
                                                {tx.user?.email || 'N/A'}
                                            </a>
                                        </td>
                                        <td className="px-4 py-3 font-mono text-xs text-gray-700">{tx.action}</td>
                                        ...
                                        <td className={`px-4 py-3 text-right font-mono ${tx.type === 'credit' ? 'text-green-600' : 'text-red-600'
                                            }`}>
                                        ...
                                        <td className="px-4 py-3 text-gray-500 max-w-[200px] truncate" title={tx.description}>
                                            {tx.description}
                                        </td>
                                    </tr>
                                ))}
